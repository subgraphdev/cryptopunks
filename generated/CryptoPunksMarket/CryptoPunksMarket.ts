...
export class CryptoPunksMarket__punksOfferedForSaleResult {
  value0: boolean;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class CryptoPunksMarket__punkBidsResult {
  value0: boolean;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class CryptoPunksMarket extends ethereum.SmartContract {
  static bind(address: Address): CryptoPunksMarket {
    return new CryptoPunksMarket("CryptoPunksMarket", address);
  }
  ...
  punksOfferedForSale(
    param0: BigInt
  ): CryptoPunksMarket__punksOfferedForSaleResult {
    ...
    return new CryptoPunksMarket__punksOfferedForSaleResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_punksOfferedForSale(
    param0: BigInt
  ): ethereum.CallResult<CryptoPunksMarket__punksOfferedForSaleResult> {
    ...
    return ethereum.CallResult.fromValue(
      new CryptoPunksMarket__punksOfferedForSaleResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt(),
  ...
  punkBids(param0: BigInt): CryptoPunksMarket__punkBidsResult {
    let result = super.call(
      "punkBids",
    ...
    return new CryptoPunksMarket__punkBidsResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt()
  ...
  try_punkBids(
    param0: BigInt
  ): ethereum.CallResult<CryptoPunksMarket__punkBidsResult> {
    let result = super.tryCall(
      "punkBids",
      "punkBids(uint256):(bool,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new CryptoPunksMarket__punkBidsResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt()
